...
class _BearerTokenCredentialPolicyBase:
    ...
    :type credential: ~gencore.credentials.TokenCredential
...
class BearerTokenCredentialPolicy(_BearerTokenCredentialPolicyBase, HTTPPolicy[HTTPRequestType, HTTPResponseType]):
    ...
    :param credential: The credential.
    :type credential: ~gencore.TokenCredential
    :param str scopes: Lets you specify the type of access needed.
    :raises: :class:`~gencore.exceptions.ServiceRequestError`
    """
    ...
    def on_request(self, request: PipelineRequest[HTTPRequestType]) -> None:
        ...
        :param ~gencore.runtime.pipeline.PipelineRequest request: the request
        """
    ...
    def on_challenge(
        ...
        :param ~gencore.runtime.pipeline.PipelineRequest request: the request which elicited an authentication challenge
        :param ~gencore.runtime.pipeline.PipelineResponse response: the resource provider's response
...
class ServiceKeyCredentialPolicy(SansIOHTTPPolicy[HTTPRequestType, HTTPResponseType]):
    ...
    :type credential: ~gencore.credentials.ServiceKeyCredential
